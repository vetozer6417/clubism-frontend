...
import { Calendar1, ChevronRight, Clock8, MapPin, Ticket } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center flex-grow w-full relative">
        ...
        <section className='w-full flex flex-col gap-3 pt-[calc(100vh/8.7)] md:pt-[calc(100vh/7)] pb-5 text-white overflow-hidden'>
        ...
        <section className='
          w-full flex flex-col gap-3 px-5 pb-5  
